...
const EditAbout = () => {
  ...
  return (
    ...
    >
      <h1 className="text-2xl sm:text-3xl font-bold text-white mb-6 sm:mb-8">Edit About Section</h1>
          ...
          {profileImagePreview && (
            ...
            >
              ...
              <img
                ...
                alt="Profile Preview"
                className="w-48 h-48 rounded-lg border border-neon-green/30 object-cover shadow-lg"
              />
            </motion.div>
          )}
        </motion.div>
